...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func getData(){
        ...
        let key = "IzaSyBlLVkXhhB32925vq4F6HAbJjfepzbnJSk"
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=A" + key)!
                ...
                if let data = data{
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            //clear core data to prevent dup data
